...
contract SupplyChain {
    ...
    function addManufacturerRole(address _account) public {
        require(_account != address(0), "Invalid account address");
        require(!hasManufacturerRole(_account), "Specified account is already a manufacturer");
    ...
    function addThirdPartyRole(address _account) public {
        require(_account != address(0), "Invalid account address");
        require(!hasThirdPartyRole(_account), "Specified account is already a third party");
    ...
    function addDeliveryHubRole(address _account) public {
        require(_account != address(0), "Invalid account address");
        require(!hasDeliveryHubRole(_account), "Specified account is already a delivery hub");
    ...
    function addCustomerRole(address _account) public {
        require(_account != address(0), "Invalid account address");
        require(!hasDeliveryHubRole(_account), "Specified account is already a customer");
    ...
    modifier verifyAddress(address add) {
        require(msg.sender == add, "Unauthorized action");
        _;
    }

    modifier manufactured(uint256 _uid) {
        require(
            products[_uid].productState == Structure.State.Manufactured, 
    ...
    modifier purchasedByThirdParty(uint256 _uid) {
        require(
            ...
            "Product not purchased by third party"
        );
        _;
    }
    ...
    modifier shippedByManufacturer(uint256 _uid) {
        require(
            ...
            "Product not shipped by manufacturer"
        );
        _;
    }
    ...
    modifier receivedByThirdParty(uint256 _uid) {
        require(
            ...
            "Product not received by third party"
        );
        _;
    }
    ...
    modifier purchasedByCustomer(uint256 _uid) {
        require(
            ...
            "Product not purchased by customer"
        );
        _;
    }
    ...
    modifier shippedByThirdParty(uint256 _uid) {
        require(
            ...
            "Product not shipped by third party"
        );
        _;
    }
    ...
    modifier receivedByDeliveryHub(uint256 _uid) {
        require(
            ...
            "Product not received by delivery hub"
        );
        _;
    }
    ...
    modifier shippedByDeliveryHub(uint256 _uid) {
        require(
            ...
            "Product not shipped by delivery hub"
        );
        _;
    }
    ...
    modifier receivedByCustomer(uint256 _uid) {
        require(
            ...
            "Product not received by customer"
        );
        _;
    }
    ...
    function manufactureProduct(
        ...
        require(hasManufacturerRole(msg.sender), "Can be called by manufacturer only");
        uint256 _uid = uid;
        Structure.Product memory product;
        product.sku = sku;
        product.uid = _uid;
    ...
    function purchaseByThirdParty(uint256 _uid) public manufactured(_uid) {
        require(hasThirdPartyRole(msg.sender), "Can be called by third party only");
    ...
    {
        require(hasCustomerRole(msg.sender), "Can be called by customer only");
    ...
    function receiveByDeliveryHub(
        ...
        require(hasDeliveryHubRole(msg.sender), "Can be called by delivery hub only");
        products[_uid].owner = msg.sender;
    ...
    {
        require(products[_uid].uid != 0, "Invalid uid");
