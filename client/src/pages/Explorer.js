                  ...
                  <Grid item xs={6}>
                    <Paper className={classes.ProductPaper}>
                      <div>
                        ...
                        <div className={classes.ExplorerdRow}>
                          Latitude of Manufacturer: {productData[0][6]}
                        </div>
                        <div className={classes.ExplorerdRow}>
                          Longitude of Manufacturer: {productData[0][7]}
                        </div>
                        <div className={classes.ExplorerdRow}>
                          Manufactured date: {format(new Date(Number(productData[1][0])), "yyyy-MM-dd")}
                        </div>
